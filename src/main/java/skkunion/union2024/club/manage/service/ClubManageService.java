...
import static skkunion.union2024.global.exception.exceptioncode.ExceptionCode.CLUB_NAME_ALREADY_EXIST;
...
public class ClubManageService {
    ...
    public void createClub(CreateClubDto req) {
        ...
        Club createdClub = Club.of(req.clubName(), req.presidentName(), req.description());
